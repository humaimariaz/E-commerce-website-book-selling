...
<div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="inputEmail4" value="${userobj.name }" name="username" required="required">
        </div>

        <div class="col-md-6">
            <label for="inputPassword4" class="form-label">Email</label>
            <input type="email" class="form-control" id="inputPassword4" value="${userobj.email }" name="email" required="required">
        </div>
    </div>
     ...
     <div class="row my-2">
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="inputEmail4" value="${userobj.phoneNo }" name="phno" required="required">
        </div>
    ...
    <div class="row my-2">
        <div class="col-md-6">
            <label for="inputEmail4" class="form-label" name="payment">Payment Method</label>
             <select class="form-select" aria-label="Default select example" name="payment">
 			<option value="noselect">Open this select menu</option>
